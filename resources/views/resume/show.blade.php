                    ...
                    <div class="card-body">
                        <div class="container">
                            <div class="row justify-content-between mt-1 mb-3">
                                <div class="col-md-3">
                                    <a class="btn btn-outline-secondary" href="{{ route('resume.index', Auth::user()->id) }}"
                                       role="button">Назад</a>
                                </div>
                                <div class="col-md-3">
                                    <a class="btn btn-outline-success" href="{{ route('resume.create', Auth::user()->id) }}"
                        ...
                        <div class="container">
                            <div class="row justify-content-around mt-3 mb-3">
                                <div class="col-md-6">
                                    <a class="btn btn-primary" href="{{ route('resume.edit', $resume->id) }}" role="button">Редактировать</a>
                                </div>
                                <div class="col-md-6">
                                    <a class="btn btn-success" href="{{ route('send-vacancies', $resume->id) }}"
                                       role="button">Просмотреть отпраленные вакансии</a>
                                </div>
                            </div>
                        </div>
                    </div>
